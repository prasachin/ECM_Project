  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <h1
            className={`text-2xl font-bold ${themeStyles.primaryText} mb-2 flex items-center justify-center transition-colors duration-300`}
          >
            Energy Dashboard
          </h1>
          <p
            className={`${themeStyles.secondaryText} flex items-center justify-center transition-colors duration-300`}
          >
